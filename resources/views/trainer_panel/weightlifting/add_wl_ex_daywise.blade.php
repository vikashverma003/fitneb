...
<div class="table-agile-info">
  <div class="panel panel-default">
    <div class="panel-heading">
      Add Weightlifting Excercise daywise
    </div>
      <div class="row">
        <div class="col-lg-12">
          <section class="panel">
            <div class="panel-body">
              <div class="form">
                ...
                @endif
                <form class="cmxform form-horizontal " id="signupForm" method="post" action="{!! url('trainer/add_wl_ex_daywise_action') !!}" novalidate="novalidate" enctype="multipart/form-data">
                  @csrf
                    <div class="form-group ">
                      <input type="hidden" name="wl_excercise_id" id="wl_excercise_id" value="{!! $id !!}">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-6">
                        <input class="form-control" id="reps" value="{{ old('reps') }}" name="reps" type="text">
                        @if ($errors->has('reps'))
                          <div class="alert alert-danger">
                            {!! $errors->first('reps') !!}
                          </div>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-6">
                        <input class="form-control" id="rest_time" value="{{ old('rest_time') }}" name="rest_time" type="text">
