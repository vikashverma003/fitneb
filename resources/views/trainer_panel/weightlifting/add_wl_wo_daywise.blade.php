...
<div class="table-agile-info">
  <div class="panel panel-default">
    <div class="panel-heading">
      Add Weightlifting Workout daywise
    </div>
      <div class="row">
        <div class="col-lg-12">
          <section class="panel">
            <div class="panel-body">
              <div class="form">
                ...
                @endif
                <form class="cmxform form-horizontal " id="signupForm" method="post" action="{!! url('trainer/add_wl_wo_daywise_action') !!}" novalidate="novalidate" enctype="multipart/form-data">
                  @csrf
                    <div class="form-group ">
                      <input type="hidden" name="wl_workout_id" id="wl_workout_id" value="{!! $id !!}">
