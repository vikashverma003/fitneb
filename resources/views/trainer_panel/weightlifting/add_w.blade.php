          ...
          <section class="panel">
            <div class="panel-body">
              <div class="form">
                ...
                @endif
                <form class="cmxform form-horizontal " id="signupForm" method="post" action="{!! url('trainer/add_weightlift_workout_action') !!}" novalidate="novalidate" enctype="multipart/form-data">
                  @csrf
