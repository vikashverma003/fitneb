                ...
                <form class="cmxform form-horizontal " id="signupForm" method="post" action="{!! url('trainer/yoga_exercise_update') !!}" novalidate="novalidate" enctype="multipart/form-data">
                  @csrf
                    <div class="form-group ">
                      <input type="hidden" name="yoga_exercise_id" value="{!! $yoga_exercise['_id'] !!}">
                      <label for="category" class="control-label col-lg-3">Category</label>
                      <div class="col-lg-6">
                        <select class="form-control" id="category" name="category">
                          <option value="">Select Category</option>
                          <option value="5c7ebafd1aa61ad19b32706f" <?php if($yoga_exercise['category'] == "5c7ebafd1aa61ad19b32706f") echo "selected"; ?>>Abs</option>
                          <option value="5c7ebb1e1aa61ad19b327070" <?php if($yoga_exercise['category'] == "5c7ebb1e1aa61ad19b327070") echo "selected"; ?>>Legs</option>
                        </select>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-6">
                        <input class="form-control" id="exercises" value="{!! $yoga_exercise['exercises'] !!}" name="exercises" type="text">
